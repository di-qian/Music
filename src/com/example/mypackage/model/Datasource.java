...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\diqia\\JavaMasterClass\\Section19\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_ALBUMS_BY_ARTIEST_START =
    ...
    public static final String INERT_SONG = "INSERT INTO " + TABLE_SONGS + '(' + COLUMN_SONG_TRACK + ", " + COLUMN_SONG_TITLE + ", " + COLUMN_SONG_ALBUM + ") VALUES(?,?,?)";
    ...
    public boolean open() {
        try {
            ...
            insertIntoSongs = conn.prepareStatement(INERT_SONG);
    ...
    public List<String> queryAlbumsForArtists(String artistName, int sortOrder) {
        StringBuilder sb = new StringBuilder(QUERY_ALBUMS_BY_ARTIEST_START);
